...
class SlideMenuOption {
    ...
    var pointOfNoReturnWidth: CGFloat = 375.0/2
...
class SlideMenuController: UIViewController, UIGestureRecognizerDelegate, PFLogInViewControllerDelegate, PFSignUpViewControllerDelegate {
