...
- (void)viewDidLoad
{
    ...
    UIViewController* typeView = [storyboard instantiateViewControllerWithIdentifier:@"typeView"];
    UIViewController* tagView = [storyboard instantiateViewControllerWithIdentifier:@"tagView"];
